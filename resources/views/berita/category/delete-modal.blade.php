        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h1 class="modal-title fs-5" id="modalLabel{{ $item->id }}">Delete Categories</h1> <!-- ID label sesuai dengan modal -->
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">

                    <form action="{{ route('admin.CategoryDelete', $item->id) }}" method="post"> <!-- Perbaikan route -->
                        @method('DELETE')
                        @csrf
                        <div class="mb-3">
                           <p>
