...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Update Data Article</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Update Data Article</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Update Data Article</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.ArticleUpdate', ['article' => $article->id]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    {{-- buat preview --}}
                                    <div class="mt-1">
                                        <img src="{{ asset('storage/back/'.$article->img) }}" alt="Image Preview" class="img-thumbnail img-preview" width="100px" style="display: block;"> <!-- Show old image -->
                                    </div>
                                </div>
