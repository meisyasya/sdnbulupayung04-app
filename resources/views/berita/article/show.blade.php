                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="{{ asset('storage/back/'.$article->img) }}" alt="{{ $article->title }}" class="img-fluid" style="max-width: 30%;">
                                    </a>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <div class="float-end" style="margin-top: 20px;">
                                <a href="{{ route('admin.ArticleIndex') }}" class="btn btn-secondary">back</a>
                            </div>
