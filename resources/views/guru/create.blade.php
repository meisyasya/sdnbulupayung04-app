...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            {{-- tambahkan route --}}
            <form action="{{ route('admin.GuruStore') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card card-primary">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputJudul">Nama Guru </label>
                            <input type="text" class="form-control" id="exampleInputJudul" name="title" placeholder="Enter Nama Guru" value="{{ old('title') }}">
                            @error('title')
                        ...
                        {{-- Deskripsi --}}
                        <div class="form-group">
                            <label for="exampleInputDeskripsi">Wali Kelas</label>
