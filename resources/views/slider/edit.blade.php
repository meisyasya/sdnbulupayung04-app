                  ...
                  <div class="card card-primary">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="exampleInputNama1" name="title" placeholder="Enter Judul" value="{{ old('title', $slider->title) }}">
                          @error('title')
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleInputDeskripsi" name="description" placeholder="Enter Deskripsi" rows="4">{{ old('description', $slider->description) }}</textarea>
                        @error('description')
                        <small style="color: red">{{ $message }}</small>
                        @enderror
                      </div>
                      ...
                      @if($slider->image)
                          <img src="{{ asset('storage/photo-user/' . $slider->image) }}" alt="Current Image" style="max-width: 200px; max-height: 200px;">
                      @endif
