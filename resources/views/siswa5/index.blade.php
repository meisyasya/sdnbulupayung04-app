...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Siswa Kelas 5</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
              {{-- data prestasi --}}
                <a href="{{ route('admin.Siswa5Create') }}" class="btn btn-primary mb-3">Tambah Data</a>
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Data Siswa Kelas 5</h3>
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                            <td>
                                <a href="{{ route('admin.Siswa5Edit', ['siswa5' => $siswa->id]) }}" class="btn btn-primary">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-between">
                                    <form action="{{ route('admin.Siswa5Delete', ['siswa5' => $siswa->id]) }}" method="post">
                                        @csrf
                                        @method('DELETE')
